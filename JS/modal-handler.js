...
function setupGoogleButtons() {
    ...
    // Only setup if button exists and doesn't have onclick attribute (layout.js handles it)
    if (googleBtn && !googleBtn.hasAttribute('data-google-setup') && !googleBtn.hasAttribute('onclick')) {
    ...
    } else if (googleBtn && googleBtn.hasAttribute('onclick')) {
        console.log("Google login button already handled by layout.js");
    }
}
