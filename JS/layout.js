document.addEventListener("DOMContentLoaded", function() {
    ...
    const headerHTML = `
        <a href="https://thenuttychocomorsels.in/" class="logo">
           <img src="../assets/images/logo-mobile.svg" alt="Logo" style="height: 35px; width: auto;">
        ...
        <div class="footer-grid">
            ...
            <div class="footer-col">
                ...
                <div class="social-icons">
                    ...
                    <a href="../Pages/whatsapp_select.html" target="_blank" class="wa-bg"><i class="fa-brands fa-whatsapp"></i></a>
                </div>
            </div>
        </div>
        <div class="copyright">&copy; ${new Date().getFullYear()} The Nutty Choco Morsels.<br class="mobile-copyright-break"> All Rights Reserved.</div>
    `;
