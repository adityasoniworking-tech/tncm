...
class BillGenerator {
    constructor() {
        this.companyInfo = {
            ...
            logo: "/assets/images/bill-image.png"
        };
        ...
        <body>
            <div class="bill-container">
                ...
                <div class="bill-header" style="background: linear-gradient(135deg, #6b0f1a, #8b2530); color: white; padding: 30px; text-align: center; border-radius: 15px 15px 0 0;">
                    <img src="/assets/images/bill-image.png" style="width: 80px; height: 80px; margin-bottom: 15px; background: white; border-radius: 50%; padding: 10px;" alt="The Nutty Choco Morsels Logo">
                ...
                <div class="bill-footer" style="background: linear-gradient(135deg, #6b0f1a, #8b2530); color: white; padding: 30px; text-align: center; border-radius: 0 0 15px 15px; margin-top: 20px;">
                    ...
                    <div style="font-size: 10px; opacity: 0.7; line-height: 1.6;">&copy; ${new Date().getFullYear()} The Nutty Choco Morsels. All Rights Reserved.</div>
